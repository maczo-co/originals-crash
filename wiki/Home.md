# maczo Originals — Crash · Provably Fair

Welcome. This wiki explains how every **Crash** result on [maczo.co](https://maczo.co) is provably
...
- 🔐 **[The Algorithm](Algorithm)** — the HMAC-SHA256 → uint32 engine + Crash's resolve step
...
- **Live (offline in your browser):** https://verify.maczo.co/originals/?game=crash
- **Source / Node CLI:** https://github.com/maczo-co/originals-crash
- **Published odds:** https://verify.maczo.co/originals/paytables/crash.json
